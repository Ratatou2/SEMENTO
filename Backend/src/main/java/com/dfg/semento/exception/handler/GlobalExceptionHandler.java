...
import com.dfg.semento.exception.AiException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    //커스텀Exception 핸들러 : RestApiException
    @ExceptionHandler(RestApiException.class)
    public ResponseEntity<Object> handleCustomException1(RestApiException e) {
        ErrorCode errorCode = e.getErrorCode();
        return handleExceptionInternal(errorCode);
    }
    //커스텀Exception 핸들러 : AiException
    @ExceptionHandler(AiException.class)
    public ResponseEntity<Object> handleCustomException2(AiException e) {
