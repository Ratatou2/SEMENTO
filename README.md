...
> SEMENTO는 4가지 모델 테스트 이후 최종적으로 **2개**의 **AI모델**을 도입하였습니다. (대략 75개의 모델 테스트)
</br>
...
<table>
  ...
  <tr>
    <td align="left" width="33%">
      <p>- [AI] RandomForest(머신러닝) 담당</p>
      <p>- FE의 로그 기반 시뮬레이션 파트 담당</p>
      <p>- 인프라 구축 담당</p>
...
<td align="left" width="33%">
      <p>- [AI] ConvLSTM 모델 담당 
        <br> &nbsp;&nbsp;&nbsp;&nbsp; - 기본적인 세팅 및 테스트
        <br> &nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp; - OverSampling
        <br> &nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp; - DataGenerator
        <br> &nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp; - Optimizer</p>
    <p>- 모델 테스트 및 성능 측정</p>
    <p>- GPU 서버 담당</p>
